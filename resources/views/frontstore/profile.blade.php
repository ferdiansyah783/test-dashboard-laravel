    ...
    <div class="w-full h-screen flex flex-col items-center">
        ...
        <div class="p-10 grid grid-cols-4 gap-4 max-w-[1080px] mx-auto">
            <div
                ...
                <a href="#">
                    <img class="p-4 rounded-t-lg" src="https://source.unsplash.com/480x480?watch" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7
